...
#define listAddNewMember(headptr, size) \
	listAddNewMember_dbg((void**)(headptr), size MEM_DBG_PARMS_INIT)
...
// End mkproto
#ifndef GENERICLIST_IMPL
/* List heads may be pointers to any record with the required link fields. */
#define listAddForeignMember(head, member) \
	(listAddForeignMember)((void**)(head), member)
#define listRemoveMember(member, head) \
	(listRemoveMember)(member, (void**)(head))
#define listFreeMember(member, head) \
	(listFreeMember)(member, (void**)(head))
#endif
#endif